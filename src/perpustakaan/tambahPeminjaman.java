...
public class tambahPeminjaman extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(876, 767));
        setResizable(false);
        getContentPane().setLayout(null);

        jLsimpan3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gambar/logo simpan_tambah.png"))); // NOI18N
        ...
        jTcariBuku.setToolTipText("Cari Buku");
        jTcariBuku.setSelectionColor(new java.awt.Color(208, 180, 142));
        ...
        jTcariAnggota.setToolTipText("Cari Anggota");
        jTcariAnggota.setSelectionColor(new java.awt.Color(208, 180, 142));
        ...
        jLclose.setBounds(810, 10, 40, 40);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gambar/tambah peminjaman.png"))); // NOI18N
    ...
    private void jTcariBukuKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTcariBukuKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTcariBukuKeyPressed
    ...
    private void jTcariAnggotaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTcariAnggotaKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTcariAnggotaKeyPressed
    ...
    private void thisdate() {
        ...
        jTtanggalPinjam.setText(""+kal.format(sekarang));
    }
    ...
    private void save(){
        String id, getIdAnggota, getNama, getEmail, getKodeBuku, getJudulBuku, getKategori, getTanggal;
        ...
        if (empty(getIdAnggota) || empty(getKodeBuku) || empty(getTanggal)) {
            ...
            try {
            Connection con = new perpustakaan.koneksi().GetConnection();
            String get = "SELECT * FROM peminjaman WHERE id_anggota = '"+getIdAnggota+"' AND kode_buku = '"+getKodeBuku+"'";
            java.sql.Statement st = con.createStatement();
